...
```{r}
library(ggplot2)
load("/home/leleu/Documents/CEM/limousin0012/expAttObs/resultat/GSMT.RData")
graphe<-ggplot(resGSM, aes(x=Exposition, y=sir))+
  geom_errorbar(width=0.5, aes(ymin=inf, ymax=sup) )+
  geom_point(size=3, shape=21, fill="white")+
  ggtitle("SIR selon le temps-exposition au réseau GSM")+
  ylab("SIR")+
...
### Régression de poisson selon le temps-exposition au réseau GSM
