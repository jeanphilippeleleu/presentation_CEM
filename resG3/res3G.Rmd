...
```{r}
library(ggplot2)
load("/home/leleu/Documents/CEM/limousin0012/expAttObs/resultat/G3.RData")
graphe<-ggplot(resGSM, aes(x=Exposition, y=sir))+
  geom_errorbar(width=0.05, aes(ymin=inf, ymax=sup) )+
  geom_point(size=3, shape=21, fill="white")+
  ggtitle("SIR selon l'exposition au réseau 3G")+
  ylab("SIR")+
...
### SLA et exposition au réseau 3G
...
### Régression de poisson selon l'exposition au réseau 3G
